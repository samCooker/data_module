...
public abstract interface XmlPullParser {
    ...
    public static final String[] TYPES                               = { "START_DOCUMENT", "END_DOCUMENT", "START_TAG",
                    "END_TAG", "TEXT", "CDSECT", "ENTITY_REF", "IGNORABLE_WHITESPACE", "PROCESSING_INSTRUCTION",
                    "COMMENT", "DOCDECL"                            };
    ...
    public abstract void setFeature(String paramString, boolean paramBoolean) throws XmlPullParserException;

    public abstract boolean getFeature(String paramString);

    public abstract void setProperty(String paramString, Object paramObject) throws XmlPullParserException;

    public abstract Object getProperty(String paramString);

    public abstract void setInput(Reader paramReader) throws XmlPullParserException;

    public abstract void setInput(InputStream paramInputStream, String paramString) throws XmlPullParserException;
    ...
    public abstract int getNamespaceCount(int paramInt) throws XmlPullParserException;

    public abstract String getNamespacePrefix(int paramInt) throws XmlPullParserException;

    public abstract String getNamespaceUri(int paramInt) throws XmlPullParserException;
    ...
    public abstract boolean isWhitespace() throws XmlPullParserException;
    ...
    public abstract boolean isEmptyElementTag() throws XmlPullParserException;
    ...
    public abstract int next() throws XmlPullParserException, IOException;

    public abstract int nextToken() throws XmlPullParserException, IOException;

    public abstract void require(int paramInt, String paramString1, String paramString2) throws XmlPullParserException,
                    IOException;

    public abstract String nextText() throws XmlPullParserException, IOException;

    public abstract int nextTag() throws XmlPullParserException, IOException;
}
