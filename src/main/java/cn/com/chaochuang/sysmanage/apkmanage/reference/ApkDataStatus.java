 ...
 *
 */
public enum ApkDataStatus implements IDictionary {
    正常数据("0"), 附件上传("1");
    private String key;
     ...
     * @param key
     */
    private ApkDataStatus(String key) {
        this(key, null);
     ...
     * @param value
     */
    private ApkDataStatus(String key, String value) {
        this.key = key;
        this.value = value;
        DictionaryRefresher.getInstance().refreshIDictionary(this);
    }
