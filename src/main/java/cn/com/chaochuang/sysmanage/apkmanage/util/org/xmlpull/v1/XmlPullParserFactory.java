/*
 * FileName:    XmlPullParserFactory.java
 * Description:
...
public class XmlPullParserFactory {
    ...
    public XmlPullParser newPullParser() throws XmlPullParserException {
        if (this.parserClasses == null) {
            throw new XmlPullParserException("Factory initialization was incomplete - has not tried "
        ...
        for (int i = 0; i < this.parserClasses.size();) {
    ...
    public XmlSerializer newSerializer() throws XmlPullParserException {
        ...
        for (int i = 0; i < this.serializerClasses.size();) {
