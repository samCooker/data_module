 ...
 *
 */
public enum VoiceEventOpinionType implements IDictionary {
    拟办意见("0"), 经办意见("1"), 处理情况("2");
     ...
     * @param key
     */
    private VoiceEventOpinionType(String key) {
        this(key, null);
     ...
     * @param value
     */
    private VoiceEventOpinionType(String key, String value) {
        this.key = key;
        this.value = value;
        DictionaryRefresher.getInstance().refreshIDictionary(this);
    }
