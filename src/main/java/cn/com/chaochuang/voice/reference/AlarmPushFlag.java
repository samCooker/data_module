 ...
 *
 */
public enum AlarmPushFlag implements IDictionary {
    未推送("0"), 已推送("1");
     ...
     * @param key
     */
    private AlarmPushFlag(String key) {
        this(key, null);
     ...
     * @param value
     */
    private AlarmPushFlag(String key, String value) {
        this.key = key;
        this.value = value;
        DictionaryRefresher.getInstance().refreshIDictionary(this);
    }
