 ...
 *
 */
public enum ShareFlag implements IDictionary {

    不共享("0"), 本单位共享("1"), 本部门共享("2");
     ...
     * @param value
     */
    private ShareFlag(String key, String value) {
        this.key = key;
        this.value = value;
        DictionaryRefresher.getInstance().refreshIDictionary(this);
    }
