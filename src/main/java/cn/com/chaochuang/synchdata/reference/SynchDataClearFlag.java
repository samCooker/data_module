/*
 * FileName:    SynchDataClearFlag.java
 * Description:
 ...
 *
 */
public enum SynchDataClearFlag implements IDictionary {
    不清空("0"), 清空("1");
     ...
     * @param key
     */
    private SynchDataClearFlag(String key) {
        this(key, null);
     ...
     * @param value
     */
    private SynchDataClearFlag(String key, String value) {
        this.key = key;
        this.value = value;
        DictionaryRefresher.getInstance().refreshIDictionary(this);
    }
