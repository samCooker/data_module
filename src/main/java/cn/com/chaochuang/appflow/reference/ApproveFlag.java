 ...
 *
 */
public enum ApproveFlag implements IDictionary {
    一类("01"), 二类无需现场检查("02"), 二类需要现场检查("03"), 三类无需现场检查("04"), 三类需要现场检查("05");
    private String key;
     ...
     * @param key
     */
    private ApproveFlag(String key) {
        this(key, null);
     ...
     * @param value
     */
    private ApproveFlag(String key, String value) {
        this.key = key;
        this.value = value;
        DictionaryRefresher.getInstance().refreshIDictionary(this);
    }
