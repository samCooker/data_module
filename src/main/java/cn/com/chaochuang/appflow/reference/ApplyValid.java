 ...
 *
 */
public enum ApplyValid implements IDictionary {
    默认状态("0"), 审批通过("1"), 审批不通过("2");
     ...
     * @param value
     */
    private ApplyValid(String key, String value) {
        this.key = key;
        this.value = value;
        DictionaryRefresher.getInstance().refreshIDictionary(this);
    }
