...
public enum DataChangeTable implements IDictionary {
    公文待办("oa_pending_handle_dts"), 审批待办("supervise_pending_handle"), 办案待办("aipcase_pending_handle"), 公文办结(
                    ...
                    "voice_event_content"), 舆情事件办理("voice_event_handle_man"), 舆情事件办理意见("voice_event_handle_approve"), 舆情事件处理意见(
                    "voice_event_handle_result"), 许可证信息("app_item_licence"), 日常检查("examine_entp_object"), 应急指挥情况汇报(
                    "em_site_report"), 审批材料清单("gxfda_app_app_prj_material"), 执业药师("gxfda_app_app_pharmacist"), 公文传输(
                    "docex_rec");
