/*
 * FileName:    DocFileOperationType.java
 * Description:
 ...
 *
 */
public enum DocFileOperationType implements IDictionary {
    呈送("0"), 办结("1"), 回退("2");
     ...
     * @param key
     */
    private DocFileOperationType(String key) {
        this(key, null);
     ...
     * @param value
     */
    private DocFileOperationType(String key, String value) {
        this.key = key;
        this.value = value;
        DictionaryRefresher.getInstance().refreshIDictionary(this);
    }
